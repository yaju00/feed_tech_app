            ...
            <div>
                ...
                <form className={styles.mainForm}>
                    ...
                    <div className="form-group">
                        ...
                        className="form-control" id="exampleInputPassword1" placeholder=" Re-enter Password"/>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                     ...
                     <div className="form-group">
                        <label >Article Prefrence(s)</label><br/>
                ...
                <button id={styles['submitBtn']} type="submit"className="btn btn-primary mx-auto,">Submit</button>
